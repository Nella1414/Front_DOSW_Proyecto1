			...
			<CardBody className="space-y-4">
				<div>
					...
					<div className="text-xs space-y-1 text-default-600">
						<p><strong>Email:</strong> du.important@gmail.com</p>
				...
				<div>
					<div className="flex items-center gap-2 mb-2">
						<Chip color="primary" variant="flat" size="sm">STUDENT</Chip>
						<span className="text-sm font-medium">Estudiante</span>
					</div>
					<div className="text-xs space-y-1 text-default-600">
						<p><strong>Email:</strong> juan.perez@escuelaing.edu.co</p>
						<p><strong>Password:</strong> 123456789</p>
